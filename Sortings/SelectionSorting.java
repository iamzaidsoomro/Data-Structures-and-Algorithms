...
public class SelectionSorting {
	...
	private static void SelectionSort(int[] array) {
		...
		// intiated a loop with conditon length -1 for ease in comparing last and second
		// last element
		for (int i = 0; i < array.length - 1; i++) {
			...
			array[i] = array[min];// then the first element will be replaced with minimum value found in nested
									// loop
