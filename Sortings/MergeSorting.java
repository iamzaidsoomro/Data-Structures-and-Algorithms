...
public class MergeSorting {
    ...
    public static void main(String[] args) {
        ...
        // mergesort = recursively divide array in 2 , then it sorts the elements
        // according to conditon , re-combine
    ...
    private static void mergeSorting(int[] array) {
        ...
        // if lenght of array reaches 1 the recursion will be stopped by returning one
        // at the end
        if (array.length <= 1)
            return;
    ...
    // this method contains three arguments ,two divided arrays and , one is main
    // array with full lenght
