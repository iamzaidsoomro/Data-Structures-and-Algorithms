...
public class BubbleSorting {
	...
	public static void main(String[] args) {
		/*
		 * Bubble sort = in Bubble sorting pairs of adjacent elements are compared , and
		 * the elements
		 * swapped if they are not in order its Quadrati time is o(n^2) it is okay for
		 * the
	...
	private static void BubbleSort(int[] array) {
		...
		for (int i = 0; i < array.length; i++) {
			...
			// intiated a nested loop with conditon (n - i -1) and this will swap the
